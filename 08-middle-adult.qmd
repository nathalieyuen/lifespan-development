...
1.  Explain the difference between primary and secondary aging

2.  Describe sensory changes that occur during middle adulthood

3.  Identify health concerns in middle adulthood

4.  Explain what occurs during the climacteric for females and males

5.  Describe sexuality during middle adulthood

6.  Explain the importance of sleep and consequences of sleep deprivation

7.  Describe the importance of exercise and nutrition for optimal health

8.  Describe brain functioning in middle adulthood
:::
...
# Figure 8.1 Contributors to Aging
# 
# Source
...
#| label: fig-08-03
#| fig-cap: >
#|   Interior of the Human Eye ([Source](https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Schematic_diagram_of_the_human_eye_en.svg/2000px-Schematic_diagram_of_the_human_eye_en.svg.png))

# Figure 8.3 Interior of the Human Eye
# 
# Source

knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Schematic_diagram_of_the_human_eye_en.svg/2000px-Schematic_diagram_of_the_human_eye_en.svg.png")
...
# Figure 8.4
# 
# Incidence of Hearing Impairment in UK Adults
# 
# Adapted from Dawes, et al., (2014).
...
: Blood Pressure Levels (Source: adapted from American Heart Association (2017)) {#tbl-08-01}
...
knitr::include_graphics("https://www.cancer.gov/sites/g/files/xnrzdm211/files/styles/cgov_enlarged/public/cgov_contextual_image/900/300/files/metastasis-enlarge.jpg?itok=0nRdnyMY")

```

There are more than 100 types of cancer. The American Cancer Society assemblies a list of the most common types of cancers in the United States. To qualify for the 2016 list, the estimated annual incidence had to be 40, 000 cases or more. The most common type of cancer on the list is breast cancer, with more than 249,000 new cases expected in 2016. The next most common 314

cancers are lung cancer and prostate cancer. Table 8.2 lists the estimated number of new cases and deaths for each common cancer type for 2019 (American Cancer Society, 2019).

| **Cancer Type**           | **Estimated New Cases** | **Estimated Deaths** |
|---------------------------|-------------------------|----------------------|
| Bladder                   | 80,470                  | 17,670               |
| Breast (Female -- Male)   | 268,600-2670            | 41,760-500           |
| Colon                     | 101,420                 | 51,020               |
| Kidney and Renal Pelvis   | 73,820                  | 14,770               |
| Leukemia (All Types)      | 61,780                  | 22,840               |
| Lung (Including Bronchus) | 228,150                 | 142,670              |
| Melanoma                  | 32,110                  | 12,960               |
...
: 2019 Estimates of Cancer Types [Source](https://www.cancer.org/content/dam/cancer-org/research/cancer-facts-and-statistics/annual-cancer-facts-and-figures/2019/cancer-facts-and-figures-2019.pdf) {#tbl-08-02}
...
: Normal Levels of Cholesterol (Source: adapted from CDC (2015)) {#tbl-08-03}
...
# Table 8.4 Estimated Number and Percentage of Adults age 18 and over with Diabetes in 2015 According to the CDC
...
#| label: fig-08-08
#| fig-cap: >
#|   Ethnic Differences in Diabetes Diagnosis ([Source](https://www.cdc.gov/media/releases/2017/p0718-diabetes-report.html))

# Figure 8.8 Ethnic Differences in Diabetes Diagnosis

knitr::include_graphics("https://www.cdc.gov/media/images/releases/2017/p0718-diabetes-report-1175px.jpg")

```

Typical tests for diabetes include a fasting glucose test and the A1C (See @tbl-08-05). Fasting glucose levels should be under 100mg/dl (ADA, 2016). The A1C provides information about the average levels of blood glucose over the last 3 months (NIH, 2014a). The A1C should be under 5.7, where a 5.0 = 97mg/dl and a 6.0 = 126 mg/dl (ADA, 2016).

|                     | **Normal**     | **Prediabetes** | **Diabetes** |
|---------------------|----------------|-----------------|--------------|
| **Fasting Glucose** | Below 100mg/dl | 100-125mg/dl    | 126mg/dl +   |
| **A1C**             | Under 5.7      | 5.7-6.9         | 7+           |

: Diagnostic Blood Tests for Diabetes (Adapted from the American Diabetes Association (2016)) {#tbl-08-05}
...
#| label: fig-08-10
#| fig-cap: >
#|   Digestive System ([Source](https://www.niddk.nih.gov/health-information/digestive-diseases/digestive-system-how-it-works?dkrd=hispt0609))

# Figure 8.10 Digestive System
# 
# Source

knitr::include_graphics("https://www.niddk.nih.gov/-/media/Images/Health-Information/Digestive-Diseases/The_Digestive_System_450x531.jpg?imbypass=true")
...
**Children in the home and sleep:** As expected, having children at home affects the amount of sleep one receives. According to a 2016 National Center for Health Statistics analysis (CDC, 2016) having children decreases the amount of sleep an individual receives, however, having a partner can improve the amount of sleep for both males and females. @fig-tbl-08-06 illustrates the percentage of individuals not receiving seven hours of sleep per night based on parental role.

```{r}
#| label: fig-tbl-08-06
#| fig-cap: >
#|   Presence of Children and Sleep (Adapted from data from CDC (2016))
...
tibble(
  ...
  mutate(
    ...
    Demographic = fct_reorder(Demographic, desc(Percentage))
  ) %>% 
  ggplot(
    aes(
      x = Demographic,
...
#| label: tbl-08-06
#| tbl-cap: >
#|   Presence of Children and Sleep
...
tibble(
  ...
  arrange(Percentage) %>% 
  rename(
    "Sleep Less than 7 hours (%)" = Percentage
  ) %>% 
  knitr::kable()
...
# Figure 8.11 The Importance of Sleep
# Source

```

Consequently, a decrease in deep sleep contributes to less growth hormone being released and subsequent physical decline seen in aging (Pattison, 2015).
...
: Estimated Calorie Needs per Day, by Age, Sex, & Physical Activity Level ([Source](https://health.gov/our-work/nutrition-physical-activity/dietary-guidelines/previous-dietary-guidelines/2015): Adapted from 2015-2020 Dietary Guidelines for Americans) {#tbl-08-07}
...
#| label: fig-08-12
#| fig-cap: >
#|  Exercise is Very Important in Middle Age ([Source](https://www.flickr.com/photos/adelphilabcenter/6185517352/in/photolist-aqAoNU-aqB6ig-a9asn5-8z28SH-aqAVjF-aqB4yF-aqAoEU-apv2ge-aqxGD8-aqAXD2-aqDMBq-aqDL4m-aqxGU4-aqxHm4-aqAopu-4FpS4b-a97Dhe-a9aqJ3-a97BwH-a9aqC5-a97Bc6-a97AFF-a97DmP-a97Dwt-a9aq9U-aqAocE-aqxH8p-aqxGLB-aqAojw-a97DRp-a98aGt-a98aD2-a9arsh-a97DrT-a97BLB-a97DcR-a9asdo-a97AKr-a9aqVh-a97DKe-a9aqRo-a9as4q-a9ap9j))

# Figure 8.12 Exercise is Very Important in Middle Age
# 
# Source

knitr::include_graphics("https://live.staticflickr.com/6162/6185517352_cb67212824_o.jpg")
...
The loss of estrogen also affects vaginal lubrication which diminishes and becomes waterier and can contribute to pain during intercourse. The vaginal wall also becomes thinner, and less elastic. Estrogen is also important for bone formation and growth, and decreased estrogen can cause osteoporosis resulting in decreased bone mass. Depression, irritability, and weight gain are often associated with menopause, but they are not menopausal (Avis, Stellato & Crawford, 2001; Rossi, 2004). Weight gain can occur due to an increase in intra-abdominal fat followed by a loss of lean body mass after menopause (Morita et al., 2006). Consequently, women may need 325

to change their lifestyle to counter any weight gain. Depression and mood swings are more common during menopause in women who have prior histories of these conditions rather than those who have not. Additionally, the incidence of depression and mood swings is not greater among menopausal women than non-menopausal women. Figure 8.12 identifies symptoms experienced by women during menopause, however, women vary greatly in the extent to which these symptoms are experienced. Most American women go through menopause with few problems (Carroll, 2016). Overall, menopause is not seen as universally distressing (Lachman, 2004).

```{r}
#| label: fig-08-13
#| fig-cap: >
#|   [Source](https://upload.wikimedia.org/wikipedia/commons/d/d9/Symptoms_of_menopause_(raster).png)

# Figure 8.13
# 
# Source

knitr::include_graphics("https://upload.wikimedia.org/wikipedia/commons/d/d9/Symptoms_of_menopause_(raster).png")
...
#| label: fig-08-14
#| fig-cap: >
#|   [Source](https://c2.staticflickr.com/4/3904/14620159866_91b177763e_z.jpg)

# Figure 8.14
# 
# Source

knitr::include_graphics("https://c2.staticflickr.com/4/3904/14620159866_91b177763e_z.jpg")
...
# Figure 8.15 Medical Check-ups are Important for Men
# 
# Source
...
::: callout-tip
Learning Objectives: Cognitive Development in Middle Adulthood • Describe crystalized versus fluid intelligence • Describe research from the Seattle Longitudinal Study • Explain the importance of flow to creativity and life satisfaction • Describe how middle adults are turning to college for advanced training • Describe the difference between an expert and a novice • Describe the changes in the U.S. work force, especially among middle adults • Explain the importance of leisure to mental health and a successful retirement
:::
...
# Figure 8.18 Seattle Longitudinal Study ages 25 to 88
...
#| label: fig-08-19
#| fig-cap: >
#|   Middle Adults in College ([Source](http://img-aws.ehowcdn.com/600x600p/photos.demandstudios.com/getty/article/165/131/86543246.jpg))

# Figure 8.19 Middle Adults in College
# 
# Source

knitr::include_graphics("http://img-aws.ehowcdn.com/600x600p/photos.demandstudios.com/getty/article/165/131/86543246.jpg")
```
...
| **16+ totals** | 74.1     | 70.2      | 67.6       | 59.6     | 57.7        | 56         |

: Percentage of the non-institutionalized civilian workforce employed by gender & age. {#tbl-08-08}
...
However, not all middle-aged adults are happy in the work place. Women may find themselves up against the glass ceiling. This may explain why females employed at large corporations are twice as likely to quit their jobs as are men (Barreto, Ryan, & Schmitt, 2009). Another problem older workers may encounter is job **burnout**, defined as *unsuccessfully managed work place stress* (World Health Organization, 2019). Burnout consists of:
...
# Figure 8.23 Legally Mandated Time Off
...
1.  Explain the controversy surrounding the concept of a midlife crisis

2.  Explain the sources of stress confronting adults in midlife and the strategies to cope

3.  Summarize Erikson's seventh psychosocial task of generativity vs stagnation

4.  Describe the relationships middle-aged adults have with their children, parents, and other family members

5.  Describe singlehood, marriage, divorce, and remarriage at midlife

6.  Describe the contemporary roles of grandparents

7.  Describe friendships at midlife

8.  Explain how women are uniquely affected at midlife

9.  Explain the role of religion at midlife
:::
...
# Figure 8.25 General Adaptation Syndrome
# 
# Source
...
# Figure 8.26 Social support is important for handling stress
# 
# Source
...
#| label: fig-08-27
#| fig-cap: >
#|   Caregiving for females is associated with greater stress ([Source](https://www.flickr.com/photos/safari_vacation/9157765300))

# Figure 8.27 Caregiving for females is associated with greater stress
# 
# Source

knitr::include_graphics("https://live.staticflickr.com/7404/9157765300_59be0aa8c5_o.jpg")
...
# Figure 8.28 How do you cope with stress when stuck in traffic?
# 
# Source
...
# Figure 8.29 Generativity at Midlife
# 
# Source
...
#| label: fig-08-38
#| fig-cap: >
#|   [Source](https://i.huffpost.com/gen/2137122/images/o-OLD-WOMEN-BEST-FRIENDS-facebook.jpg)

# Figure 8.38
#
# Source

knitr::include_graphics("https://i.huffpost.com/gen/2137122/images/o-OLD-WOMEN-BEST-FRIENDS-facebook.jpg")
...
Fry, R. (2017). It's becoming more common for young adults to live at home-and for longer stretches. Retrieved from:

https://www.pewresearch.org/fact-tank/2017/05/05/its-becoming-more-common-for-young-adults-to-live-at-home-and-for-longer-stretches/ft_17-05-03_livingathome_bygen2/
...
Kang, S. W., & Marks, N. F. (2014). Parental caregiving for a child with special needs, marital strain, and physical health: Evidence from National Survey of Midlife in the U.S. 2005. *Contemporary Perspectives in Family Research, 8*A, 183-209.
...
Proctor, D. N., Balagopal, P., & Nair, K. S. (1998). Age-related sarcopenia in humans is associated with reduced synthetic rates of specific muscle proteins. *Journal of Nutrition, 128*(2 Suppl.), 351S-355S. 368
...
Sandgerg-Thoma, S. E., Synder, A. R., & Jang, B. J. (2015). Exiting and returning to the parental home for boomerang kids. *Journal of Marriage and Family, 77*, 806-818. doi:10.1111/jomf.12183
...
Twisk, J. W., Snel, J., Kemper, H. C., & van Mechelen, W. (1999). Changes in daily hassles and life events and the relationship with coronary heart disease risk factors: A 2-year longitudinal study in 27--29-year-old males and females. *Journal of Psychosomatic Research, 46*, 229--240. 370
...
World Health Organization. (2018). *Top 10 causes of death*. Retrieved from
